	...
	$.getJSON("../server/fetch_categories.php", function(data){
		if(data){
			...
			$.each(data, function(i, category){
				json_data = "<div class='col l3 m6 s6 center display_data_in_card'><a href='category_master.php?category="+category.nicename+"'><div class='div_with_bg_img' style='background: url(../"+category.img+"); background-size: 100%;'><div class='div_text_item' style='height: 30px;'>"+category.name+"</div></div></a></div>";
